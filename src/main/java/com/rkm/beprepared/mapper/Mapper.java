package com.rkm.beprepared.mapper;
...
import com.rkm.beprepared.dto.response.*;
import com.rkm.beprepared.model.*;
...
public class Mapper {
    ...
    public List<CitizenResponseDto> mapCitizenResponseDtoList(List<Citizen> citizens) {
