...
import com.rkm.beprepared.dto.request.AlertRequestDto;
import com.rkm.beprepared.dto.response.AlertResponseDto;
...
public class AlertController {
    ...
    @GetMapping("/city")
    public ResponseEntity<List<AlertResponseDto>> getAllActiveAlertsByCityId(@RequestParam Long cityId){
        return ResponseEntity.ok(mapper.mapAlertToResponseDtoList(
                alertService.getAllAlertsByCityId(cityId)
        ));
    }
    @GetMapping("/province")
    public ResponseEntity<List<AlertResponseDto>> getAllAlertsByProvinceId(@RequestParam Long provinceId){
        return ResponseEntity.ok(mapper.mapAlertToResponseDtoList(
