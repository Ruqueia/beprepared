package com.rkm.beprepared.exception.handler;
...
public class APIExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private final MessageSource messageSource; /*pega as mensages*/
    @Override
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
                                                                  HttpHeaders headers, HttpStatusCode status,
                                                                  WebRequest request) {
        HttpStatus httpStatus = HttpStatus.BAD_REQUEST; //*o client cometeu erro*/
        ...
        response.setTitle("ERRO DE VALIDACAO DE DADOS! Um ou mais campos nao validos");
    ...
    public ResponseEntity<Object> EntityNotFoundException(BadRequestException ex, HttpServletRequest request) {
